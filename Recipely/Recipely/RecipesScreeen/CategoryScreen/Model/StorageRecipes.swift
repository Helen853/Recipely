// StorageRecipes.swift
// Copyright © RoadMap. All rights reserved.

/// Хранилище рецептоов
struct StorageRecipes {
    var fish: [Recipes] = [
        .init(
        ...
        .init(
            imageFoodName: "imageFood6",
            foodName: "Chilli and Tomato Fish",
            foodTime: 60,
            foodKkal: 274,
            isFavorites: false
        ),
        .init(
            ...
            foodName: "Basked Fish with Lemon Herb Sauce",
            foodTime: 100,
            foodKkal: 410, isFavorites: false
        ),
        .init(
            imageFoodName: "imageFood4",
            foodName: "Fast Roast Fish & Show Peas Recipes",
            foodTime: 100,
            foodKkal: 174, isFavorites: false
        ),
        .init(
            imageFoodName: "imageFood1",
            foodName: "Simple Fish And Corn",
    ...
    var chicken: [Recipes] = [
        ...
        .init(
            ...
            foodName: "Basked Fish with Lemon Herb Sauce",
            foodTime: 90,
            foodKkal: 344, isFavorites: false
        ),
        .init(
            imageFoodName: "imageFood4",
            foodName: "Fast Roast Fish & Show Peas Recipes",
            foodTime: 80,
            foodKkal: 122, isFavorites: false
        )
    ]
}
