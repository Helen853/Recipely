...
//    }
    ...
    private func configureView() {
        ...
        // imageShimmerView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -20).isActive = true
    ...
    private func configureTitleStack() {
        ...
        // titleStackView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -20).isActive = true
    }
